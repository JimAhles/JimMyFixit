...
namespace MyFixIt.App_Start
{
    public class DependenciesConfig
    {
        public static void RegisterDependencies()
        {
            ...
            // to use a different logger, just comment out following line and uncomment the logger you want.
            // note that Logger appears to have a problem writing to text file.
            // also, in log4net, still using windows.diagnostics for trace, in loggernlog using NLog.Trace statement
           // builder.RegisterType<LoggerNLog>().As<ILogger>().SingleInstance();
